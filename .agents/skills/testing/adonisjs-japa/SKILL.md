...
version: 0.1.0
description: Reusable AdonisJS and Japa testing guidance. Use when adding, updating, diagnosing, or running tests in projects that use AdonisJS with Japa, including unit, functional, API, browser, database, and regression tests.
---
